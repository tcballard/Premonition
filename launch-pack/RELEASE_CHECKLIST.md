...
| --- | --- | --- | --- | --- | --- |
| Release identity | Version, build, date and availability agree | Signed 0.1.0 candidate; brief and cask; no public release | Ready | Tom Ballard | Keep unpublished qualification consistent |
| Claims | Every used claim is verified or visibly qualified | Initial C01-C13 ledger | Draft | Tom Ballard | Remove blocked claims from outputs or resolve them |
| Assets | Required outputs exist and open correctly | Signed app/ZIP and fixtures ready; narrative/video missing | Missing | Tom Ballard | Produce S6 outputs |
