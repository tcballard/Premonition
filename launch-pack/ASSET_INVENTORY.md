...
| A06 | Timed demo script and shot list | Three-minute narrated demonstration | Product-demo workflow and verified Launch Pack claims | Must cover product, Codex and GPT-5.6; captions required | `launch-pack/outputs/demo-script.md`, `launch-pack/outputs/demo-shot-list.md` | Draft | Owner reviews script/staging; then capture genuine signed-app footage |
