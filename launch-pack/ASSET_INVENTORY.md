...
| A04 | README front door | Setup, safety and provenance | Repository evidence and verified boundary commits | Public source and unpublished signed archive are distinguished | `README.md` | Ready | Keep availability wording aligned downstream |
...
| A10 | Repository access route | Judge source/testing access | Owner-confirmed public GitHub repository | MIT source; signed archive remains unpublished | `https://github.com/tcballard/Premonition` | Ready | Use as the official judging repository |
